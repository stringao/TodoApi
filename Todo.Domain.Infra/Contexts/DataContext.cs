...
public class DataContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TodoItem>().Property(x => x.StateTodo);
        modelBuilder.Entity<TodoItem>().Property(x => x.BeginDate);
        modelBuilder.Entity<TodoItem>().Property(x => x.DurationTime);
